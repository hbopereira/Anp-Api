...
import com.example.anpapi.mail.Mailer;
...
public class LancamentoService {
	...
	public void avisarSobreLanacamentosVencidos() {
		...
		List<Lancamento> vencidos = lancamentoRepo
		...
		List<Usuario> destinatarios = usuRepo
	...
	public byte[] relatorioPorTipoPessoa(LocalDate inicio, LocalDate fim) throws JRException {
		List<LancamentoEstatisticaPessoa> dados = lancamentoRepo.porPessoa(inicio, fim);
