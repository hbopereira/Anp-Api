package com.example.anpapi.exceptionhandler;
...
@ControllerAdvice
public class AnpExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		String mensagemUsuário = messageSource.getMessage("recurso.operacao-nao-permitida", null, LocaleContextHolder.getLocale());
	...
	private List<Erro> listaDeErros(BindingResult result){
		List<Erro> erros = new ArrayList<>();
		
		for(FieldError field: result.getFieldErrors()) {
		  String mensagemUsuário = messageSource.getMessage(field, LocaleContextHolder.getLocale());
	...
	public static class Erro{
		...
		public void setMensagemUsuário(String mensagemUsuário) {
			this.mensagemUsuário = mensagemUsuário;
		}
